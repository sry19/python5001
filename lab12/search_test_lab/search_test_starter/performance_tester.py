...
def main():
    testLinear_search = 1000
    start_linear = 1000
    end_linear = 10000
    increment = 1000
    for i in range(start_linear, end_linear + 1, increment):
        test_linear_search(i, testLinear_search, ordered=True)

    testBinary_search = 1000
    start_binary = 1000
    end_binary = 10000
    for i in range(start_binary, end_binary + 1, increment):
        test_binary_search(i, testBinary_search)

    testFind_median = 100
    start_median = 100
    end_median = 1000
    increment = 100
    for i in range(start_median, end_median + 1, increment):
        test_median(i, testFind_median)
